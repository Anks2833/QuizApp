const questions=[
    ...
    {
        question:"Which of the following are valid ways to represent color in css?",
        answers:[
            {text:"HEX value",correct:false},
            {text:"RGB value",correct:false},
            {text:"Valid color name",correct:false},
            {text:"All of the above",correct:true},
        ]
    },
    {
        question:"CSS property use to specify the transparency of element is",
        answers:[
